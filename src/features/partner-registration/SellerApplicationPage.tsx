...
export function SellerApplicationPage() {
  ...
  return <main className="partner-registration"><header><button aria-label="Назад" onClick={() => navigate(-1)}><ArrowLeft /></button><span>Проверка бизнеса</span></header><form onSubmit={submit}>
