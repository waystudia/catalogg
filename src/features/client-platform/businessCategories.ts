...
const BUSINESS_CATEGORY_SEEDS = [
  ...
  },
  {
    ...
    icon: 'basket',
    imageUrl: '/assets/mangal-demo/products/grilled-vegetables.webp',
    accentColor: '#20b65d',
    sortOrder: 20,
    isActive: true,
    businessTypes: []
  ...
  },
  {
    ...
    icon: 'flower',
    imageUrl: '/assets/templates/confectionery/products/strawberry-chocolate-6.webp',
    accentColor: '#ef3f83',
    sortOrder: 40,
    isActive: true,
    businessTypes: []
  },
  {
    ...
    icon: 'home',
    imageUrl: '/assets/template-coffee-shop/hero.webp',
    accentColor: '#3977ee',
    sortOrder: 50,
    isActive: true,
    businessTypes: []
  },
  {
    ...
    icon: 'pharmacy',
    imageUrl: '/assets/mangal-demo/products/still-water.webp',
    accentColor: '#1db878',
    sortOrder: 60,
    isActive: true,
    businessTypes: []
  },
  {
    ...
    icon: 'pet',
    imageUrl: '/assets/mangal-demo/products/bone-steak.webp',
    accentColor: '#f28b18',
    sortOrder: 70,
    isActive: true,
    businessTypes: []
  },
  {
    ...
    icon: 'gift',
    imageUrl: '/assets/templates/confectionery/products/gift-set-for-her.webp',
    accentColor: '#8a5cea',
    sortOrder: 80,
    isActive: true,
    businessTypes: []
...
const matchesDiscoveryFilters = (
  ...
  const typeDefinition = getBusinessTerms(businessType);
